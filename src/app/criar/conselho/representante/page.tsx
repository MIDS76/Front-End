...
export default function RepresentantePage() {
  ...
  const lista = [
    { id: 1, nome: "Raquel_silva", email: "raquel@gmail.com", role: "Aluno", isActive: true },
    ...
    { id: 6, nome: "Henrique Menel", email: "herique_menel@gmail.com", role: "Aluno", isActive: true },
      ...
      <main className="flex-1 px-12 pt-8 pb-12 mt-20">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t border-[hsl(var(--border))] mt-4 pt-4">
              <div className="flex justify-between items-center mb-3">
                ...
                <input
                  ...
                  className="border border-[hsl(var(--border))] rounded-md px-3 py-1 text-sm w-60 bg-[hsl(var(--muted))] focus:outline-none focus:ring-2 focus:ring-[hsl(var(--primary))]"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-14 mt-6">
            <div className="bg-[hsl(var(--card))] rounded-xl border border-[hsl(var(--border))] shadow-sm w-[760px] h-[480px] p-5 flex flex-col">
          ...
          {/* Mensagem de limite */}
          <div className="flex justify-end items-center mt-4 w-[775px] mx-auto pr-4">
            {maxMessage && (
              <span className="text-[hsl(var(--destructive))] text-sm font-medium animate-pulse">
