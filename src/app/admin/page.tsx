        ...
        try {
            ...
            if (turmasArray?.length) {
                ...
                resultados.forEach((conselho, index) => {
                    ...
                    if (typeof turma.id === 'number' && turma.id > 0) {
                        if (conselho) {
                            if (conselho.etapas === etapaFinalizada && conselho.dataFim) {
            ...
            console.error("Erro ao carregar dados da página admin:", error);
            setAllTurmas([]);
        } finally {
            setIsLoading(false);
        }
                ...
                <div className="flex flex-row flex-auto">
                    ...
                    <div ref={modalRef}>
                        <ListaConselhos
                            ...
                            role={user?.role ?? ""}
                            onConselhoUpdate={fetchData} // Adicionado para atualizar a lista após um conselho ser finalizado/criado
                        />
